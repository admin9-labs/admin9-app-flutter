...
class AppBrand {
  ...
  static const newsBlueBrand = AppBrand(
    ...
    gradientMiddle: Color(0xffd9ecff),
  ...
  static const defaultBrand = AppBrand(
    ...
    label: '蓝花楹',
    primary: Color(0xff5a3fcc),
    gradientStart: Color(0xfff9f7ff),
    gradientMiddle: Color(0xffe7deff),
    gradientEnd: Color(0xff9b7cff),
  );
  ...
  static const all = [
    AppBrand(
      ...
      gradientStart: Color(0xfffff7f5),
      gradientMiddle: Color(0xffffd9d9),
      gradientEnd: Color(0xfff04444),
    ),
    newsBlueBrand,
    AppBrand(
      id: AppBrandId.livelihoodGreen,
      label: '民生绿',
      primary: Color(0xff0f7a35),
      gradientStart: Color(0xfff8fff9),
      gradientMiddle: Color(0xffddf6e5),
      gradientEnd: Color(0xff35c46b),
    ),
    AppBrand(
      id: AppBrandId.hotOrange,
      label: '热点橙',
      primary: Color(0xff993d00),
      gradientStart: Color(0xfffff8f1),
      gradientMiddle: Color(0xffffddbd),
      gradientEnd: Color(0xffff8a2a),
    ),
    AppBrand(
      id: AppBrandId.cityGold,
      label: '城市金',
      primary: Color(0xff6b4f0d),
      gradientStart: Color(0xfffffbef),
      gradientMiddle: Color(0xfff4de9d),
      gradientEnd: Color(0xffd6a536),
    ),
    defaultBrand,
  ];
